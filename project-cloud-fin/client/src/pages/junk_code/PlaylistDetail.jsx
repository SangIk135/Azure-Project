...
import { PlayIcon, PlusIcon, ShareIcon, EditIcon, TrashIcon } from '../components/icons/Icons';
      ...
      <div>
        {playlist.songs.map((song, index) => (
          <SongItem key={song.id}>
            ...
            {isOwner && (
              <Button type="button" danger className="delete-btn" onClick={() => handleSongDelete(song.id)}>
                <TrashIcon />
              </Button>
            )}
          </SongItem>
